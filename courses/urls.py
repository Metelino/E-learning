...
from .views import (ListCourses, course_edit, course_add, course_view, course_delete,
node_add, node_edit, node_view, node_delete, file_delete, file_add, question_delete, question_add, stream_file, lesson_passed)
